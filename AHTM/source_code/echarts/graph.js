...
define('echarts/chart/graph/GraphSeries', ['require', '../../data/List', 'zrender/core/util', '../../util/model', '../../model/Model', '../helper/createGraphFromNodeEdge', '../../echarts'], function (require) {
    ...
    var GraphSeries = require('../../echarts').extendSeriesModel({
            ...
            ifEnableAnimation: function () {
                return GraphSeries.superCall(this, 'ifEnableAnimation') && !(this.get('layout') === 'force' && this.get('force.layoutAnimation'));
            },
            defaultOption: {
                zlevel: 0,
                z: 2,
...
define('echarts/chart/graph/forceLayout', ['require', './forceHelper', '../../util/number', './simpleLayoutHelper', './circularLayoutHelper', 'zrender/core/vector', 'zrender/core/util'], function (require) {
