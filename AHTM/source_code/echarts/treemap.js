...
define('echarts/chart/treemap/TreemapSeries', ['require', '../../model/Series', '../../data/Tree', 'zrender/core/util', '../../model/Model', '../../util/format', './helper'], function (require) {
    var SeriesModel = require('../../model/Series');
...
define('echarts/chart/treemap/treemapAction', ['require', '../../echarts', './helper'], function (require) {
    var echarts = require('../../echarts');
    var helper = require('./helper');
    var noop = function () {
    };
...
define('echarts/chart/treemap/treemapLayout', ['require', 'zrender/core/util', '../../util/number', '../../util/layout', './helper', 'zrender/core/BoundingRect'], function (require) {
    var zrUtil = require('zrender/core/util');
    var numberUtil = require('../../util/number');
    var layout = require('../../util/layout');
    var helper = require('./helper');
...
define('echarts/chart/treemap/TreemapView', ['require', 'zrender/core/util', '../../util/graphic', '../../data/DataDiffer', './helper', './Breadcrumb', '../../component/helper/RoamController', 'zrender/core/BoundingRect', 'zrender/core/matrix', '../../util/animation', '../../echarts'], function (require) {
    ...
    var PATH_LABEL_NORMAL = [
            'label',
            'normal'
        ];
    var PATH_LABEL_EMPHASIS = [
            'label',
            'emphasis'
        ];
    var Z_BASE = 10;
...
define('echarts/chart/treemap/helper', ['require', 'zrender/core/util'], function (require) {
    var zrUtil = require('zrender/core/util');
    var helper = {
...
define('echarts/chart/treemap/Breadcrumb', ['require', '../../util/graphic', '../../util/layout', 'zrender/core/util', './helper'], function (require) {
    var graphic = require('../../util/graphic');
    var layout = require('../../util/layout');
    var zrUtil = require('zrender/core/util');
    var helper = require('./helper');
