...
define('echarts/component/singleAxis', ['require', '../coord/single/singleCreator', './axis/SingleAxisView', '../coord/single/AxisModel', '../echarts'], function (require) {
...
define('echarts/coord/single/singleCreator', ['require', './Single', '../../CoordinateSystem'], function (require) {
...
define('echarts/component/axis/SingleAxisView', ['require', './AxisBuilder', 'zrender/core/util', '../../util/graphic', '../../echarts'], function (require) {
...
define('echarts/coord/single/AxisModel', ['require', '../../model/Component', '../axisModelCreator', 'zrender/core/util', '../axisModelCommonMixin'], function (require) {
    var ComponentModel = require('../../model/Component');
...
define('echarts/coord/single/Single', ['require', './SingleAxis', '../axisHelper', '../../util/layout'], function (require) {
...
define('echarts/coord/single/SingleAxis', ['require', 'zrender/core/util', '../Axis', '../axisHelper'], function (require) {
    var zrUtil = require('zrender/core/util');
